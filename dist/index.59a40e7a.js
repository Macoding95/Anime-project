...
var _recommendViewJs = require("./views/recommendView.js");
...
const controlResults = async function() {
    ...
    (0, _recommendViewJsDefault.default).render(_modelJs.state.recommend);
};
...
},{}]},["8UT0b","8lRBv"], "8lRBv", "parcelRequire1acb")
